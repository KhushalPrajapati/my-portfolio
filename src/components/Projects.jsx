...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A responsive tourism website built with HTML, CSS, JavaScript, and Bootstrap, featuring interactive elements and a modern design to enhance user experience.',
      image: 'https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?w=600&h=400&fit=crop&crop=center',
      techStack: ['HTML', 'CSS', 'JavaScript', 'Bootstrap'],
      githubUrl: 'https://github.com/KhushalPrajapati/tourism'
    },
  ];
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      >
        ...
        >
          <motion.a
            href="https://github.com/KhushalPrajapati?tab=repositories" // Replace with your actual GitHub profile
            target="_blank"
            rel="noopener noreferrer"
