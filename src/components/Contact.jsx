...
const Contact = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'khushal45y@gmail.com',
      href: 'mailto:khushal45y@gmail.com'
    },
    {
      icon: Phone,
      label: 'Phone',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceId = 'service_jqra2vi'; // Replace with your EmailJS service ID
      const templateId = 'template_gdcunzh'; // Replace with your EmailJS template ID
      const publicKey = 'alb9OSvY5sM10PdJ4'; // Replace with your EmailJS public key

      // Email template parameters
      const templateParams = {
        from_name: formData.name,
        from_email: formData.email,
        to_email: 'khushal45y@gmail.com',
